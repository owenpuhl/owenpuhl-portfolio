export const TRACKS = [
  {
    ...
    title: 'Cyber Glitch',
    description: 'Algorithmic generative composition using randomized control functions. Unique output on each run!',
    genre: 'Cyber',
...
$: s("~ ~ ~ white")
  ...
  {
    id: 'main-beat',
    title: 'Electronic-ish',
    description: 'Skeleton for an electronic sound, building off.',
    genre: 'Electroclash',
...
$: s("glitch").n(rand.range(0, 9))
  ...
  },
  {
    ...
    title: 'Sawtooth Progression',
    description: 'Classic pop progression (I–V–vi–IV) with aggressive sawtooths.',
    genre: 'Electroclash',
...
$: note("c4*8 g4*8 a4*8 f4*8")
  ...
  },
  {
    ...
    title: 'Lydian Harmonies',
    description: 'Harmonic suspension and (attempt) at atmosphere through Lydians.',
    genre: 'Witchpop',
...
$: note("c4*8 d4*8 c4*8 d4*8")
  ...
  },
  {
    ...
    title: 'Minimal Dark',
    description: 'Minimalist composition with kick, hi-hat, bass note, and noise layer.',
    genre: 'Electroclash',
...
$: s("white")
  ...
  },
  {
    ...
    title: 'Chromatics',
    description: 'Chromatic chord descent, ending with tonal resolution.',
    genre: 'Electroclash',
...
$: note("c4*8 bb4*8 ab4*8 g4*8")
  ...
  },
  {
    ...
    description: 'Minor key progression with half-step chromatic movement. Microtonal harmonic inflection to create crunchier tonal systems.',
    genre: 'Witchpop',
